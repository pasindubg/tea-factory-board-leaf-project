...
Welcome — this repository implements the Board Leaf (tea factory) product.

- Please read the full milestone plan in [MILESTONES.md](MILESTONES.md).
- Current project status: **We are still in Milestone 3 (Web dashboard core).**

## Quick pointer

The canonical milestone plan, verification gates, and phase-2 vision live in
[MILESTONES.md](MILESTONES.md). That file contains the full step-by-step
milestones (M0–M13) and standing rules for development.

## Milestones (full content)

The section below includes the complete contents of `MILESTONES.md` for
convenience. For the authoritative source and to see updates, open
...
Thank you for checking in — open [MILESTONES.md](MILESTONES.md) for the
authoritative plan and to follow progress.
