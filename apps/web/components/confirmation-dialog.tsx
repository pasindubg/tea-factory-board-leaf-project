...
export function ConfirmationDialog({
  ...
  return createPortal(
    <>
      <button type="button" aria-label="Cancel confirmation" data-action-feedback-ignore disabled={busy} onClick={onCancel} className="fixed inset-0 z-[140] cursor-default bg-stone-950/35 backdrop-blur-[2px]" />
      <section data-action-feedback-ignore role="alertdialog" aria-modal="true" aria-labelledby="confirmation-title" aria-describedby="confirmation-description" className="fixed left-1/2 top-1/2 z-[150] w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-[1.5rem] border border-stone-200 bg-white p-6 shadow-2xl dark:border-stone-700 dark:bg-stone-900">
