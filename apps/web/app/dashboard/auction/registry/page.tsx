...
const addBtn = "rounded-md bg-green-700 px-4 py-2 text-sm font-medium text-white hover:bg-green-800";
...
export default async function RegistryPage({
  ...
  return (
    <div className="space-y-10">
      ...
      <section>
        <h2 className="text-lg font-medium text-stone-700">Brokers</h2>
        <p className="text-sm text-stone-500">The auction houses that catalogue, value and settle your teas.</p>
        <div className="mt-4 grid gap-6 md:grid-cols-2">
          ...
          <form action={createBroker} className="space-y-3 rounded-xl border border-stone-200 bg-white p-4">
            <div>
      ...
      <section>
        <h2 className="text-lg font-medium text-stone-700">Estate marks</h2>
        <p className="text-sm text-stone-500">The selling identities you trade under (e.g. MF1530 KUMUDU).</p>
        <div className="mt-4 grid gap-6 md:grid-cols-2">
          <div className="overflow-x-auto rounded-xl border border-stone-200 bg-white">
            <table className="w-full text-sm">
              <thead>
          ...
          <form action={createMark} className="space-y-3 rounded-xl border border-stone-200 bg-white p-4">
            <div>
