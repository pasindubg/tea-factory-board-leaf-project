...
export function NewBundledDispatchBootstrap({
  ...
  return (
    <div className="rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-700 dark:bg-stone-900">
      ...
      <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">No physical dispatches exist yet for this factory. Enter the dates it covers and the warehouse it leaves from.</p>
      <div className="mt-5">
        <BundledDispatchForm
          today={today}
