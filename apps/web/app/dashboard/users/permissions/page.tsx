  ...
  return (
    <div>
      <div className="flex items-center gap-3">
        <a href="/dashboard/users" className="text-sm text-stone-500 dark:text-stone-400 hover:text-stone-700 dark:hover:text-stone-200">
          ← Users
        </a>
      ...
      {error  && <p className="mt-4 rounded-md bg-red-50 dark:bg-red-950 p-3 text-sm text-red-700 dark:text-red-400"   role="alert">{error}</p>}
      {notice && <p className="mt-4 rounded-md bg-green-50 dark:bg-green-950 p-3 text-sm text-green-800 dark:text-green-400" role="status">{notice}</p>}
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {configurableModules.map((mod) => (
                <tr key={mod.key} className="border-b border-stone-100 dark:border-stone-800 last:border-0">
                    ...
                    return (
                      <td key={role} className="px-4 py-3 text-center">
                        <input
                          ...
                          className="h-4 w-4 rounded border-stone-300 dark:border-stone-600 text-green-600 dark:text-green-400 focus:ring-green-600"
                        />
                      </td>
                    );
                  })}
      ...
      <div className="mt-6 rounded-lg border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-950 p-4 text-xs text-stone-500 dark:text-stone-400 space-y-1">
