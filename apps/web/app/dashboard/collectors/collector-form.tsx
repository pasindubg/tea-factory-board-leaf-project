  ...
  return (
    <form action={action} className="mt-6 max-w-lg space-y-4 rounded-xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 p-6">
      ...
      <div className="flex gap-3 pt-2">
        ...
        <a href="/dashboard/collectors" className="rounded-md border border-stone-300 dark:border-stone-600 px-4 py-2 text-sm hover:bg-stone-100 dark:hover:bg-stone-800">
          Cancel
        </a>
      </div>
    </form>
