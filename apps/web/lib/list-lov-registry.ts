...
const sources: Record<LovSourceKey, LovSourceDefinition> = {
  ...
  "leaf.vehicles": {
    ...
    table: "vehicles",
    valueColumn: "id",
    labelColumn: "vehicle_no",
    descriptionColumn: "make_model",
    searchColumns: ["vehicle_no", "make_model"],
    orderBy: [{ column: "vehicle_no" }],
    scope: { active: true },
  },
  "leaf.drivers": {
    moduleKey: "drivers",
    ...
    valueColumn: "id",
    labelColumn: "name",
    descriptionColumn: "phone",
    searchColumns: ["name", "phone", "licence_no"],
    orderBy: [{ column: "name" }],
    scope: { active: true },
  },
  "leaf.lines": {
    ...
    labelColumn: "line_no",
    descriptionColumn: "name",
    searchColumns: ["line_no", "name"],
    orderBy: [{ column: "line_no" }],
    scope: { active: true },
  },
};
