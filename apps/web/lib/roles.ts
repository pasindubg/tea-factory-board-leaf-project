...
export const MODULES: readonly ModuleDef[] = [
  ...
  { key: "auction-dispatch-detail", href: "/dashboard/auction/new", label: "Invoice Details", roles: ["owner", "manager", "accountant"], entitlement: "auction", group: "Dispatch Handling" },
